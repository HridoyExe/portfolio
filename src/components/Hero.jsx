...
const Hero = () => {
  ...
  const text = "Architecting the Future of Web Systems";
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-24">
          ...
          >
            ...
            <motion.h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold text-white mb-4 lg:mb-6 leading-[1.1] lg:leading-[1.05] font-display">
              <span className="block text-slate-500 font-light text-xl md:text-2xl mb-1 lg:mb-2">Hello, I'm</span>
              <span className="text-gradient block mb-2 lg:mb-4">Forman Ali</span>
              <div className="flex flex-wrap justify-center lg:justify-start gap-x-2 md:gap-x-3 text-2xl md:text-4xl lg:text-5xl text-slate-400 font-medium">
                {words.map((word, i) => (
                  <motion.span 
                    key={i} 
                    variants={itemVariants}
                    className={word === "Future" || word === "Web" ? "text-white" : ""}
                  >
                    {word}
                  </motion.span>
                ))}
          ...
          >
            <div className="relative w-64 h-64 sm:w-72 sm:h-72 md:w-[400px] md:h-[400px] lg:w-[480px] lg:h-[480px] mx-auto group">
              ...
              {/* Profile Wrapper */}
              <div className="absolute inset-0 bg-slate-900 rounded-[3rem] p-1.5 transition-shadow duration-700 group-hover:shadow-[0_0_80px_rgba(6,182,212,0.15)] relative overflow-hidden animate-float">
                ...
                <motion.div
                  ...
                  className="absolute bottom-10 -right-4 glass px-6 py-3 rounded-2xl border-white/10 shadow-2xl flex items-center gap-3 backdrop-blur-3xl"
                >
                  <HiCheckCircle className="text-cyan-400 text-xl" />
                  <span className="text-white font-bold text-xs font-display">Specialized Backend</span>
                </motion.div>
              </div>
