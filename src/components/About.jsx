...
const About = () => {
  const techStack = [
    ...
    { category: 'Frameworks & Libraries', items: 'Django, DRF, React, Tailwind CSS' },
      ...
      <div className="container mx-auto px-8 max-w-6xl">
        <div className="space-y-24">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
            ...
            {/* Journey */}
            <SectionReveal delay={0.4} yOffset={30}>
              <div className="space-y-12">
                <div className="section-label">
                ...
                <div className="space-y-12">
                  {journey.map((period, i) => (
                    <motion.div 
                      ...
                      className="relative pl-12 border-l border-white/5 pb-8 last:pb-0"
                    >
