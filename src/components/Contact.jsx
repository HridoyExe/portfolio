    ...
    <section id="contact" className="py-32 bg-black min-h-screen">
      <div className="container mx-auto px-8 max-w-4xl">
        <div className="flex flex-col space-y-16">
          ...
          <SectionReveal delay={0.2} yOffset={20}>
            <form className="space-y-6 md:space-y-8" onSubmit={(e) => e.preventDefault()}>
              ...
              <motion.button 
                ...
                className="w-full bg-white text-black font-bold uppercase tracking-widest text-[10px] py-4 rounded-2xl hover:bg-zinc-200 transition-colors"
              >
                Send Message
              </motion.button>
            </form>
          ...
          {/* WhatsApp Support */}
          <SectionReveal delay={0.4} yOffset={20}>
